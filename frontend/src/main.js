...
const I18N = {
  zh: {
    ...
    hero_p3: "🎁 打狗的人还有一笔隐形押金：<b>Pump.fun 交易量累加器</b>（约 0.0018 SOL/账户，有的还累积返现）。别的工具扫不到，本系统<b>扫得到、全额退、免手续费</b>。",
    ...
    guide_p3: "另外，打狗的人还有 <b>Pump.fun 交易量押金（累加器）</b>：在 pump.fun 上交易会自动创建累加器账户，锁约 0.0018 SOL，有的还累积返现。它挂在 pump.fun 程序名下、不是普通代币账户，多数工具扫不到。solata.top 能扫出来并<b>全额退回、免手续费</b>。",
  ...
  en: {
    ...
    hero_p3: "🎁 Pump.fun traders have one more hidden deposit: the <b>Pump.fun volume accumulator</b> (~0.0018 SOL/account, sometimes with accumulated cashback). Other tools can't see it — we <b>scan it, reclaim it in full, no fee</b>.",
