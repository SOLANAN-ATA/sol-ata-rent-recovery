...
async function classifyAndChunk(userPk, platformPk, opts = {}) {
  ...
  if (!targets.length) {
    return { chunks: [], perChunkNet: [], targetCount: 0, totalRent: 0, totalFee: 0, totalNet: 0 };
  }
  ...
  return { chunks, perChunkNet, targetCount: targets.length, totalRent, totalFee, totalNet };
}
